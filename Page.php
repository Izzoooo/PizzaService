...
EOT;
        ...
        if (strlen($jsFile) > 0 && substr("$jsFile", -3) == ".js") {
            echo <<<EOT
...
<nav class="NavClass">
  <ul>
    <li><a href="bestellung.php">Bestellen</a></li>
  <li><a href="kunde.php">Kunde</a></li>
 <li> <a href="KundenStatus.php" target="_blank">KundenStatus JSON</a></li>
 <li> <a href="fahrer.php">Fahrer</a></li>
  ...
  <section class="top-nav"> <!-- für Handy CSS -->
    <div>
      EWA
    </div>
